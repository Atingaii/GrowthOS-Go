...
| [ADR-0028](ADR-0028-identity-session-authentication.md) | 已接受（实现候选；最终验收待完成） | 由独立 Identity 上下文以 Argon2id、MySQL opaque session、受约束 Cookie/CSRF 与 runtime/provision/maintenance 最小权限边界产生可信 human Principal |
