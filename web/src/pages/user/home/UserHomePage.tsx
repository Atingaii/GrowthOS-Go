...
import { mockCampaigns, mockPointTransactions } from "../../../mocks/growthOsMockData";
import { useAppStore } from "../../../stores/appStore";

const trendData = [
  { date: "8/24", balance: 11980, income: 0, expense: 0 },
  { date: "8/25", balance: 12040, income: 60, expense: 0 },
  { date: "8/26", balance: 12190, income: 150, expense: 0 },
  { date: "8/27", balance: 12240, income: 50, expense: 0 },
  { date: "8/28", balance: 12300, income: 60, expense: 0 },
  { date: "8/29", balance: 12150, income: 50, expense: 200 },
  { date: "8/30", balance: 12450, income: 300, expense: 0 },
] as const;
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(240px,0.82fr)] lg:gap-12">
      ...
      >
        ...
        <div className="py-4">
          <div className="text-sm font-medium text-zinc-500 dark:text-zinc-400">本周新增</div>
...
function RecentOverview() {
  return (
    <div className="grid gap-2 rounded-xl bg-zinc-100 p-2 lg:grid-cols-3 dark:bg-zinc-900">
      ...
      <OverviewCard title="7 天收入统计" value="LDC 620.00">
        <StatBars rows={incomeRows} tone="success" />
      </OverviewCard>

      <OverviewCard title="7 天支出统计" value="LDC 200.00">
    ...
    <div className="space-y-10">
      <section className="space-y-6" aria-labelledby="home-title">
        <PageHeader
          titleId="home-title"
          title="今天"
          description={`欢迎回来，${user.name}。这里展示的是用于学习界面与增长业务建模的演示快照，不代表真实账户账务。`}
          badge="演示数据"
        />
        <TrendPanel />
      </section>
