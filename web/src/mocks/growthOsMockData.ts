...
export const MOCK_SNAPSHOT_LABEL = "2026-03-14 12:00 CST";
...
export const mockFeedItems: GrowthFeedItem[] = [
  {
    ...
    content:
      "By replacing manually triggered onboarding emails with dynamic MCP Agent tools that trigger personalized in-app reward popups when users drop off at step 3, our conversion skyrocketed.",
    tag: "Case Study",
    likes: 342,
    shares: 89,
    comments: 24,
  ...
  },
  {
    ...
    authorAvatar:
      "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=120&h=120&fit=crop&auto=format",
    ...
    content:
      'Experiment "Ref-AB-99" reached statistical significance (p < 0.01). Automated recommendation: Shift 80% of campaign traffic budget to Variant B immediately.',
    tag: "A/B Experiment",
    likes: 512,
    shares: 140,
    comments: 45,
...
export const mockCoupons: Coupon[] = [
  ...
  },
  {
    id: "cpn_2",
    code: "AGENTVIP",
    title: "Free 1,000 AI Agent Credits",
    discount: "100% OFF",
    minSpend: "$0.00",
  ...
  },
  {
    id: "cpn_3",
    code: "SPRING20",
    title: "20% Rebate on MCP Gateway",
    discount: "20% OFF",
    minSpend: "$200.00",
...
export const mockPointTransactions: PointTransaction[] = [
  {
    id: "tx_1",
    type: "earn",
    title: "Completed Spring Campaign Referral Task",
    amount: 500,
    date: "2026-03-14 10:22",
    status: "completed",
  },
  {
    id: "tx_2",
    type: "earn",
    title: "Daily Check-in Streak Reward",
    amount: 50,
  ...
  },
  {
    id: "tx_3",
    type: "spend",
    title: "Redeemed $20 Coupon Voucher",
    amount: -2000,
  ...
  },
  {
    id: "tx_4",
    type: "earn",
    title: "AI Operator Workflow Execution Bonus",
    amount: 1200,
...
export const mockMcpServers: McpServer[] = [
  {
    id: "srv_1",
    name: "growthos-analytics-mcp",
    version: "v1.4.2",
    status: "online",
    endpoint: "https://mcp.growthos.io/analytics",
    toolsCount: 14,
    avgLatencyMs: 28,
    activeRequests: 142,
  },
  {
    id: "srv_2",
    name: "growthos-marketing-agent-mcp",
    version: "v2.1.0",
    status: "online",
    endpoint: "https://mcp.growthos.io/agent",
    toolsCount: 8,
    avgLatencyMs: 45,
    activeRequests: 89,
  },
  {
    id: "srv_3",
    name: "growthos-user-behavior-mcp",
    version: "v0.9.8",
    status: "degraded",
    endpoint: "https://mcp.growthos.io/behavior",
    toolsCount: 6,
    avgLatencyMs: 210,
    activeRequests: 12,
  },
...
export const mockMcpTools: McpTool[] = [
  {
    id: "tool_1",
    serverId: "srv_1",
    serverName: "growthos-analytics-mcp",
    name: "calculate_funnel_conversion",
    description:
      "Calculates multi-stage conversion rates & friction drop-offs across user cohorts.",
    riskLevel: "low",
  ...
  },
  {
    id: "tool_2",
    serverId: "srv_2",
    serverName: "growthos-marketing-agent-mcp",
    name: "trigger_points_reward",
    description: "Dispatches instant point grants or coupon vouchers directly to user accounts.",
    riskLevel: "high",
    invocations24h: 890,
    successRate: 98.5,
  },
  {
    ...
    description: "Dynamically reallocates marketing campaign spending limits.",
    riskLevel: "critical",
    invocations24h: 142,
    successRate: 100.0,
  },
...
export const mockAgentTasks: AgentTask[] = [
  {
    ...
    prompt:
      "Analyze conversion drop-off on /campaigns/cmp_001, run A/B test simulation, and adjust user reward threshold.",
  ...
  },
  {
    ...
    prompt:
      "Query churn-risk Platinum users (>30 days inactive) and grant 1,000 $50 discount vouchers.",
