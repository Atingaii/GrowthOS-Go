  ...
  },
  {
    ...
    children: [
      ...
      { path: "campaigns", Component: AdminCampaignsPage },
      {
        path: "strategies",
        Component: () => (
          <GenericAdminModulePage
            title="抽奖策略"
            subtitle="配置抽奖概率与策略控制"
            icon={Target}
          />
        ),
      },
      ...
      },
      {
        path: "accounts",
        Component: () => (
          <GenericAdminModulePage title="用户账户" subtitle="查看全网用户积分与账号" icon={Users} />
        ),
      },
      {
        path: "points",
        Component: () => (
          <GenericAdminModulePage title="积分策略" subtitle="积分发放与规则引擎" icon={Coins} />
        ),
      },
      {
        path: "coupons",
      ...
      },
      {
        path: "rebates",
        Component: () => (
          <GenericAdminModulePage title="返利中心" subtitle="裂变佣金与比例配置" icon={Percent} />
        ),
      },
      {
        path: "feed",
        Component: () => (
          <GenericAdminModulePage title="Feed 管理" subtitle="审核与推荐社区 Feed" icon={Rss} />
        ),
      },
      {
        path: "behavior",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "tools",
        Component: () => (
          <GenericMcpPage title="Tools 工具库" subtitle="管理已暴露给 Agent 的工具" icon={Wrench} />
        ),
      },
      {
        path: "permissions",
        Component: () => (
          <GenericMcpPage title="安全与权限" subtitle="MCP Tool 风险等级策略" icon={ShieldCheck} />
        ),
      },
      {
        path: "audit",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "history",
        Component: () => (
          <GenericAgentPage title="执行历史" subtitle="归档与审计历史 AI 执行记录" icon={History} />
        ),
      },
    ],
  },
