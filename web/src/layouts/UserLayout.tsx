        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="hidden lg:flex items-center gap-0.5 mr-2">
              <Link to="/admin/dashboard" className="px-2 py-1 text-xs text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 flex items-center gap-1 rounded font-mono">
                <Shield className="w-3 h-3" /> Admin
              </Link>
              <Link to="/mcp/dashboard" className="px-2 py-1 text-xs text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 flex items-center gap-1 rounded font-mono">
            ...
            {/* Notifications */}
            <button className="relative p-2 text-stone-400 hover:text-stone-700 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-neutral-800 rounded">
            ...
            {/* User Profile */}
            <Link to="/profile" className="flex items-center gap-2 ml-1 pl-3 border-l border-stone-200 dark:border-neutral-700">
              <img src={user.avatar} alt={user.name} className="w-7 h-7 rounded-full object-cover" />
              <div className="hidden xl:block text-left">
                <div className="text-xs font-semibold leading-none text-stone-800 dark:text-stone-200">{user.name}</div>
                <div className="text-[10px] text-blue-600 dark:text-blue-400 font-mono mt-0.5">{user.points.toLocaleString()} pts</div>
              </div>
            </Link>
          </div>
        </div>
